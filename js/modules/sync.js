...
window.SyncMod = (function() {
  ...
  const CFG_MAP = { amapJs: 'k_amap_js', amapSrv: 'k_amap_srv', newsApi: 'k_news_api', llm: 'k_llm_api', llmModel: 'k_llm_model', xfAppId: 'k_xf_appid', xfApiKey: 'k_xf_apikey', xfApiSecret: 'k_xf_apisecret' };
